...
export const CATEGORIES = [
  ...
  new Category('c1', 'ADELE', '#f5428d'),
  new Category('c2', 'BILLIE ELISH', '#f54242'),
  new Category('c3', 'NIRVANA', '#f5a442'),
  new Category('c4', 'THE STROKES', '#f5d142'),
  new Category('c5', 'THE NEIGBOORHOOD', '#368dff'),
  new Category('c6', 'TOP', '#41d95d'),
  new Category('c7', 'UN CORAZON', '#9eecff'),
  new Category('c8', 'MARINA', '#b9ffb0'),
  new Category('c9', 'STRAYKIKDS', '#ffc7ff'),
  new Category('c10', 'MELANIE MARTINEZ', '#47fced')
];
